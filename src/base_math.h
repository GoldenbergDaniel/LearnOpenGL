...
#define V2F_HORIZONTAL (Vec2F) {1.0f, 0.0f}
#define V2F_VERTICAL (Vec2F) {0.0f, 1.0f}
...
Mat4x4F rotate_4x4(f32 angle, Vec3F axis); // do we need the axis here? Yes
Mat4x4F scale_4x4f(f32 scale);
Mat4x4F shear_4x4f(f32 shear);
